...
app.engine('hbs', hbs.engine({ extname: 'hbs',defaultLayout: "layout", layoutsDir: __dirname + '/views/layouts/', partialsDir: __dirname + '/views/partials/',adminDir:__dirname+'/views/admin/',userDir:__dirname+'/views/user/',  helpers:{
  total:(qty,price)=>{
    return qty * price
  },
